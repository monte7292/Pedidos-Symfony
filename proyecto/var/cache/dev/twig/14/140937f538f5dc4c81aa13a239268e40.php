...
/* correo.html.twig */
class __TwigTemplate_0cd36aa3b1314615546881e63ef730ec extends Template
{
...
<h1>¡Gracias por su compra ";
        // line 4
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 4, $this->source); })()), "user", [], "any", false, false, false, 4), "login", [], "any", false, false, false, 4), "html", null, true);
        yield "!</h1>
...
<table>
    ...
    ";
      ...
      <td>";
            // line 23
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["coste"]) || array_key_exists("coste", $context) ? $context["coste"] : (function () { throw new RuntimeError('Variable "coste" does not exist.', 23, $this->source); })()), "html", null, true);
            yield "€</td>
     </tr>
    ";
        }
...
<p>Precio total: ";
        // line 28
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["coste"]) || array_key_exists("coste", $context) ? $context["coste"] : (function () { throw new RuntimeError('Variable "coste" does not exist.', 28, $this->source); })()), "html", null, true);
        yield "€</p>
";
...
<p>Precio total: {{ coste }}€</p>
", "correo.html.twig", "/var/www/html/templates/correo.html.twig");
    }
}
